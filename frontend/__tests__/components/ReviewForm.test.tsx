...
type ReviewFormData = { bookId: string; text: string; rating: number };
...
describe('ReviewForm Component', () => {
  ...
  const defaultProps = {
    bookId: 'book123',
    onSubmit: mockSubmit as unknown as (data: ReviewFormData) => Promise<void>,
    isSubmitting: false
  };
  ...
  test('renders create review form correctly', () => {
    ...
    // Use getByText instead of getByLabelText since it's not properly connected
